...
from models import FewShotCIL, focal_loss,FewShotCILwoRn2_encoder,MYCIL
...
class MYNET(nn.Module):
    ...
    def __init__(self, args, mode=None):
        ...
        self.encoder = FewShotCILwoRn2_encoder(args)  # pretrained=True follow TOPIC, models for cub is imagenet pre-trained. https://github.com/xyutao/fscil/issues/11#issuecomment-687548790
        self.num_features = 512
